...
public class TravellerListHorizontalMeal extends RecyclerView.Adapter<TravellerListHorizontalMeal.ViewHolder> {
    ...
    public TravellerListHorizontalMeal(MealFragment frag, View view, Activity ctx, TravellerInfo obj, int segment, ArrayList<ArrayList<TravellerAddon>> travellerAddonSegment, int max) {
        this.c = ctx;
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        Log.e("TravellerName", travellerAddonSegment.get(segment).get(i).getTravellerName());
