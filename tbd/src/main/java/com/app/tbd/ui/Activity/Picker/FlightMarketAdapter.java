...
public class FlightMarketAdapter extends BaseAdapter {
    Context context;
    ...
    String[] filteredChar;
    FlightMarketPicker frag;

    public FlightMarketAdapter(Context context, FlightMarketPicker frag, ArrayList<DropDownItem> countries, ArrayList<DropDownItem> oriCountries, String whichList2) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (whichList.equals("FLIGHT")) {
            ...
            tvCountry.setPadding(15, 20, 0, 20);
        }

        return view;
    }

    public void filter(String charText, ArrayList<DropDownItem> xx) {
        charText = charText.toLowerCase();
        countries.clear();
        originalCountries = xx;
